...
//custom script by codebymick
	wp_enqueue_script('core', get_bloginfo('template_url').'/assets/js/codebymick.js', array('jquery'), false, true);
...
// CUSTOM POST TYPES
function horaserweg_custom_post_types() {

	    // cutomer loyalty quotes - Erfahrungen
		$labels = array(
			'name'               => _x( 'Erfahrungen', 'post type general name', 'horaserweg'),
			'singular_name'      => _x( 'Erfahrung', 'post type singular name', ''),
			'menu_name'          => _x( 'Erfahrungen', 'admin menu', 'horaserweg'),
			'name_admin_bar'     => _x( 'Erfahrungen', 'add new on admin bar', 'horaserweg'),
			'add_new'            => _x( 'Neuer Erfahrung', 'book', 'horaserweg'),
			'add_new_item'       => __( 'Neuen Erfahrung hinzufügen', 'horaserweg'),
			'new_item'           => __( 'Neuer Erfahrung', 'horaserweg'),
			'edit_item'          => __( 'Erfahrung bearbeiten', 'horaserweg'),
			'view_item'          => __( 'Erfahrung ansehen', 'horaserweg'),
			'all_items'          => __( 'Alle Erfahrungen', 'horaserweg'),
			'search_items'       => __( 'Erfahrungen durchsuchen', 'horaserweg'),
			'parent_item_colon'  => __( 'Übergeordneter Erfahrung', 'horaserweg'),
			'not_found'          => __( 'Keine Erfahrungen gefunden', 'horaserweg'),
			'not_found_in_trash' => __( 'Keine Erfahrungen gefunden', 'horaserweg')
		);
		$args = array(
			'labels'             => $labels,
			'description'        => __('Alle Erfahrungen des gegend', 'horaserweg'),
			'public'             => true,
			...
			'has_archive'        => false,
			'hierarchical'       => true,
			'supports'           => array('title', 'editor', 'thumbnail', 'excerpt', 'revisions','comments', 'custom-fields', 'page-attributes')
		);
		register_post_type('Erfahrungen', $args);

}
add_action('init', 'horaserweg_custom_post_types');
